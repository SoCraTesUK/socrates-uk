...
Trainer: [Gemma Cameron](#gemma-cameron)
...
Trainers: [Duncan McGregor](#duncan-mcgregor) and [Nat Pryce](#nat-pryce)
...
Trainer: [Clare Sudbery](#clare-sudbery)
...
Trainer: [Emily Bache](#emily-bache)
...
Trainer: [Tim Ottinger](#tim-ottinger)
...
{% include_relative covid_precautions.md %}
